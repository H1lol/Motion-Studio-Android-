...
private fun drawTextureToScreen(texture: Int) {
    ...
    /**
     * Returns the SurfaceTexture that a MediaCodec decoder should render into.
     * MainActivity calls this after the renderer is ready, then passes the
     * result to a VideoDecoder's configure() call.
     */
    fun getVideoSurface(): SurfaceTexture? = videoSurface
